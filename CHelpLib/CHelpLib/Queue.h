...
typedef struct _Queue
{
    ...
    HRESULT (*Insert)(struct _Queue* pThis, PVOID pValOut, int nValSize);
    HRESULT (*Delete)(struct _Queue* pThis, PVOID pValOut, BOOL fGetPointerOnly);
    HRESULT (*Peek)(struct _Queue* pThis, PVOID pVal, BOOL fGetPointerOnly);
...
DllExpImp HRESULT CHL_DsDeleteQ(_In_ PCHL_QUEUE pQueueObj, _Inout_opt_ PVOID pValOut, _In_opt_ BOOL fGetPointerOnly);
DllExpImp HRESULT CHL_DsPeekQ(_In_ PCHL_QUEUE pQueueObj, _Inout_opt_ PVOID pValOut, _In_opt_ BOOL fGetPointerOnly);
